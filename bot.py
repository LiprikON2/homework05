...
def get_near_lesson(message):
    ...
    while days_offset < 15 and not is_class_found:
        day = get_day(date=today['date'] +
    ...
    resp += '<b>{}</b>, {}, {}\n'.format(
        times_lst[class_number], locations_lst[class_number], lessons_lst[class_number])
    bot.send_message(message.chat.id, resp, parse_mode='HTML')
...
# ERROR 409 FIX:
# https://ru.stackoverflow.com/questions/977284/%d0%a2%d0%b5%d0%bb%d0%b5%d0%b3%d1%80%d0%b0%d0%bc-%d0%b1%d0%be%d1%82-%d0%bd%d0%b0-heroku-%d0%bf%d0%b5%d1%80%d0%b5%d1%81%d1%82%d0%b0%d0%bb-%d1%80%d0%b0%d0%b1%d0%be%d1%82%d0%b0%d1%82%d1%8c-%d1%81%d0%be-%d1%81%d1%82%d1%80%d0%b0%d0%bd%d0%bd%d0%be%d0%b9-%d0%be%d1%88%d0%b8%d0%b1%d0%ba%d0%be%d0%b9
